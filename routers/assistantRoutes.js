...
router.route('/').get(getAllAssistants).post(upload.fields([{ name: 'files', maxCount: 5 }, { name: 'avatar', maxCount: 1 }]) , createAssistant);
...
router.patch("/updatedatawithfile/:assistant_id/",upload.fields([{ name: 'files', maxCount: 5 }, { name: 'avatar', maxCount: 1 }]) , updateAssistantDataWithFile);
